...
const test1 = ["abcdef", "bababc", "abbcde", "abcccd", "aabcdd", "abcdee", "ababab"]
console.log(part1(input));


const test2 = ["abcde", "fghij", "klmno", "pqrst", "fguij", "axcye", "wvxyz"]

function part2(list) {
    let match;
    let baseChars;

    while (match == null && list.length > 0) {
        const base = list.pop();
        ...
        list.forEach(id => {
            ...
            const isTooDifferent = baseChars.some((char, index) => {
